...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1458291935654890827L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"apptest.beans\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public static apptest.beans.OrderItem.Builder newBuilder() {
    return new apptest.beans.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static apptest.beans.OrderItem.Builder newBuilder(apptest.beans.OrderItem.Builder other) {
    return new apptest.beans.OrderItem.Builder(other);
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static apptest.beans.OrderItem.Builder newBuilder(apptest.beans.OrderItem other) {
    return new apptest.beans.OrderItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(apptest.beans.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(apptest.beans.OrderItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderItem.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderItem.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderItem.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderItem.Builder clearPrice() {
