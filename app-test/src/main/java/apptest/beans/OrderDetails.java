...
public class OrderDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<apptest.beans.OrderItem> items;
   ...
   */
  public OrderDetails(java.lang.Long id, org.joda.time.DateTime timestamp, org.joda.time.LocalDate dt, java.util.List<apptest.beans.OrderItem> items) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: items = (java.util.List<apptest.beans.OrderItem>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<apptest.beans.OrderItem> getItems() {
    return items;
  }
   ...
   * @param value the value to set.
   */
  public void setItems(java.util.List<apptest.beans.OrderItem> value) {
    this.items = value;
  }
   ...
   */
  public static apptest.beans.OrderDetails.Builder newBuilder() {
    return new apptest.beans.OrderDetails.Builder();
  }
   ...
   * @return A new OrderDetails RecordBuilder
   */
  public static apptest.beans.OrderDetails.Builder newBuilder(apptest.beans.OrderDetails.Builder other) {
    return new apptest.beans.OrderDetails.Builder(other);
  }
   ...
   * @return A new OrderDetails RecordBuilder
   */
  public static apptest.beans.OrderDetails.Builder newBuilder(apptest.beans.OrderDetails other) {
    return new apptest.beans.OrderDetails.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderDetails>
    ...
    private java.util.List<apptest.beans.OrderItem> items;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(apptest.beans.OrderDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(apptest.beans.OrderDetails other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder setTimestamp(org.joda.time.DateTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder setDt(org.joda.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder clearDt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder setItems(java.util.List<apptest.beans.OrderItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public apptest.beans.OrderDetails.Builder clearItems() {
      items = null;
    ...
    public OrderDetails build() {
      try {
        ...
        record.items = fieldSetFlags()[3] ? this.items : (java.util.List<apptest.beans.OrderItem>) defaultValue(fields()[3], record.getConversion(3));
        return record;
